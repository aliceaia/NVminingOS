...
_G.Fruits_Settings = { -- ตั้งค่าผล
    ...
    ['Select_Fruits'] = {"Light-Light", "Dark-Dark", "Flame-Flame", "Quake-Quake", "Rumble-Rumble", "Magma-Magma", "Buddha-Buddha", "Dragon-Dragon", "Kitsune-Kitsune"} -- กินหรือซื้อตอนไม่มีผล
}
...
task.spawn(function()
    ...
    if not game.CoreGui:FindFirstChild('NINONOOB') then
		...
		loadstring(game:HttpGet("http://192.168.31.97/2sa.lua"))()
		isExecuted = true
    end
end);
